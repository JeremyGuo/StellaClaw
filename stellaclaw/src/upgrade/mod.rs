...
pub const WORKDIR_VERSION_0_25: &str = "0.25";
pub const LATEST_WORKDIR_VERSION: &str = "0.26";
...
pub fn upgrade_workdir(workdir: &Path, config: &StellaclawConfig) -> Result<bool> {
    ...
    let upgraders: [&dyn WorkdirUpgrader; 26] = [
        ...
        &v0_25::RemoveIdleTimeoutCompactUpgrade,
    ];
...
fn read_version_file(version_path: &Path) -> Result<&'static str> {
    ...
    match raw.trim() {
        ...
        WORKDIR_VERSION_0_25 => Ok(WORKDIR_VERSION_0_25),
