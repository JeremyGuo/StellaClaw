...
use crate::config::{
    StellaclawConfig, CONFIG_VERSION_0_10, CONFIG_VERSION_0_11, CONFIG_VERSION_0_2,
    CONFIG_VERSION_0_3, CONFIG_VERSION_0_4, CONFIG_VERSION_0_5, CONFIG_VERSION_0_6,
    CONFIG_VERSION_0_7, CONFIG_VERSION_0_8, CONFIG_VERSION_0_9, LATEST_CONFIG_VERSION,
...
pub fn load_config_file_and_upgrade(path: &Path) -> Result<(StellaclawConfig, bool)> {
    ...
    let mut config = match version.as_str() {
        ...
        LATEST_CONFIG_VERSION => v0_12::load(&raw, path)?,
